...
export class UpsertPromptPayDto { @IsEnum(PromptPayType) type!: PromptPayType; @IsString() target!: string; @IsString() accountName!: string; @Type(() => Number) @IsInt() @Min(0) @Max(31) invoiceDueDays = 5; @Type(() => Number) @IsInt() @Min(0) @Max(10000) lateFeePerDay = 0; }
