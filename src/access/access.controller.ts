...
export class AccessController {
  ...
  @Get('permissions') @PlatformOnly() @RequirePermissions('role.view') permissions() { return this.service.permissionMatrix(); }
  @Get('roles') @PlatformOnly() @RequirePermissions('role.view') roles(@CurrentUser() user: RequestUser) { return this.service.listRoles(user); }
